...
require (
	...
	open-cluster-management.io/multicloud-operators-channel v0.13.0
...
replace k8s.io/client-go v12.0.0+incompatible => k8s.io/client-go v0.26.11
...
replace k8s.io/api v0.29.3 => k8s.io/api v0.26.11
